...
public class ProductRepositoryImpl implements ProductRepositoryCustom {
  ...
  // alex>>>
  // change DB query to increment number of views
  // CREATE TABLE alex_history (p_id BIGINT(20) NOT NULL, viewed_at datetime DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(p_id) REFERENCES PRODUCT(PRODUCT_ID))
  @Override
  public void setHistory(int p_id) {
    em.createNativeQuery("INSERT INTO alex_history (p_id) VALUES (?)")
      .setParameter(1, p_id)
      .executeUpdate();
	}

  // DB query to return the most number of views
  @Override
  public List getMostViewed() {
    return em.createNativeQuery("SELECT * FROM alex_history")
      .getResultList();
  }
  // alex<<<
